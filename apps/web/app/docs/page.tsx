...
export default function Docs() {
  return <main className="prose">
    ...
    <p>Revive is a desktop-guided, deterministic process. It never asks an AI to decide what to flash.</p>
    ...
    <p>The browser first proves it is paired to the initiating Revive Desktop session using a signed, one-time local challenge. The connected injected wallet then authorizes checkout and, for paid orders, signs an exact 29 USDC mainnet transaction. The permanent entitlement binds to the cross-checked PSG1 identifier—not the wallet or computer.</p>
    ...
    <p>Reconnect the physical PSG1 and run the scan to recover an existing entitlement. A wallet change, factory reset, OS reinstall, or different computer does not consume a second license.</p>
  </main>;
}
