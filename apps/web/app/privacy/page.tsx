...
export default function Privacy() {
  return <main className="prose">
    ...
    <p>Hosting providers process service data on our behalf. Solana wallet addresses and transactions are public blockchain records outside Revive&apos;s control. A final notice must name production processors, regions, transfer safeguards, and user-rights procedures.</p>
    <h2>Retention</h2>
