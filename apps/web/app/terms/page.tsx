...
export default function Terms() {
  ...
  return <main className="prose">
    ...
    <h2>{earlyAccessFree ? "Free forever" : "License"}</h2>
    <p>{earlyAccessFree ? "Revive is free forever. Donations are optional, do not purchase additional rights, and do not affect compatibility or access." : "A purchase licenses one compatible PSG1 device and includes updates released for that licensed device. The paying wallet receives the receipt but is not the device identifier."} A factory reset, supported OS reinstall, wallet change, or move to another computer does not consume another device activation.</p>
